...
try {
  ...
  // series / taylor recognized as calc calls
  eq(findInnermostCall("series(sin(x), 0, 5)")?.name, "series", "series name");
  eq(findInnermostCall("series(sin(x), 0, 5)")?.inner, "sin(x), 0, 5", "series inner");
